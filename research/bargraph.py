...
# def plot_dynamic_bargraph(df):
#     # Ensure the first column is 'applications' and other columns are numeric
#     if df.empty or 'applications' not in df.columns:
#         print("Invalid DataFrame: It must contain an 'applications' column.")
#         return
    
#     # Extract applications (X-axis)
#     applications = df['applications']
    
#     # Extract all other columns (Y-axis values)
#     data_columns = df.drop(columns=['applications'])
...
# # Example usage
# data = {
#     'applications': ['WhatsApp', 'Signal', 'Telegram', 'Discord'],
#     'Usage1': [100, 120, 150, 90],
#     'Usage2': [200, 180, 170, 160],
#     'Usage3': [50, 60, 40, 80]
# }

# df = pd.DataFrame(data)
# plot_dynamic_bargraph(df)
import click
import pandas as pd
import matplotlib.pyplot as plt
