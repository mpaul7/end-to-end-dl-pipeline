...
def build_model(hp):
    ...
    print(stat_features_tr)
        
    inputs = {name: layers.Input(shape=(57,), dtype=tf.float32, name=name) for name in stat_features_tr}
...
# =========
    ...
    # Add output layer
    outputs = tf.keras.layers.Dense(25, activation='softmax', name='softmax')(x)
...
def main():
    ...
    X, y, tf_dataset = create_train_test_dataset_tf(
